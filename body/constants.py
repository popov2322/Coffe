...
class LongPrints:
    ...
    coffee_db_lines = [("espresso", 15), ("latte", 30), ("cappuccino", 25), ("tea", 20), ("americano", 20),
                       ("water", 5), ("zest",1),('sugar', 1), ("syrup", 3), ("cane_sugar", 2), ("cinnamon", 2), ("none", 0)]
